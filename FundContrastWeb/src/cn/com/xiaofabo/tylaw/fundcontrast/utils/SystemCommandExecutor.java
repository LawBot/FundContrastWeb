...
public class SystemCommandExecutor {
	 ...
	 * here:
	 * 
	 * List<String> commands = new ArrayList<String>(); commands.add("/sbin/ping");
	 * commands.add("-c"); commands.add("5"); commands.add("www.google.com");
	 * SystemCommandExecutor commandExecutor = new SystemCommandExecutor(commands);
	 * commandExecutor.executeCommand();
	 * 
	 * Note: I've removed the other constructor that was here to support executing
	 * the sudo command. I'll add that back in when I get the sudo command working
	 * to the point where it won't hang when the given password is wrong.
	 * 
	...
	public int executeCommand() throws IOException, InterruptedException {
		...
		try {
			...
			// i'm currently doing these on a separate line here in case i need to set them
			// to null
			...
			// these need to run as java threads to get the standard output and error from
			// the
			// command.
			// the inputstream handler gets a reference to our stdOutput in case we need to
			// write
			...
			// TODO the inputStreamHandler has a nasty side-effect of hanging if the given
			// password
			// is wrong; fix it
